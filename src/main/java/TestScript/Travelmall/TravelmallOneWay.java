...
import entities.Travelmall_FOneway;
import utilities.QaDataProvider;
import utilities.QaExcelRead;

public class TravelmallOneWay extends Flightcheck {
	TestBase t;
	QaExcelRead reader;
