...
import entities.TransferOneWay_Search;
import utilities.QaDataProvider;
import utilities.QaExcelRead;
import utilities.QaRobot;

public class TransferOneWay extends Flightcheck {
	...
	public static void transferOneway(String ccode,String Country, String Pickuptype, String dropofftype, String pickuplocation,
			...
			String Tbooking, String Arrival, String terminal, String flightno, String hours, String minute,
		...
		TransferOneWay_Search.Transfer_OneWaysearch(ccode,Country, Pickuptype, dropofftype, pickuplocation, pickloctionlist,
				dropofflocation, droplocationlist, adult, child, departdate, servicetime, Extratime, currency,
				nationality, Tbooking, Arrival, terminal, flightno, hours, minute, email, title, adultfname, adultlname,
				...
				type,cardno,cardname,cardmonth,cardyear,cardcvv,btitle, bfname,blname,baddress,bcity,bcityauto,bstate,bzipcode,bcountry);
