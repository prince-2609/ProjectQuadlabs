...
public class BusinessHotelTrip 
{
	...
	public Object[][] getexceldata() throws Exception {
		...
		return QaDataProvider.getTestdata("SBT_Hotel", "BusinessSheet1");
	}
	...
	public static void Sbt_flight_Search(String TestCaseId,String Employee,String TravelArranger,String ccode, String URL,String compcode, String uname, String pwd, String corptraveller,String searchType,
			...
			String cvv, String resultpagestep, String checkoutPageStep, String hotelReasonCode, String hotelRemarks,String CreatedBy)
			throws Exception 
	{
		...
		QaExtentReport.test.log(Status.INFO, "<b><i>Travel Arranger Name is  </i></b>"+TravelArranger);
		// select the traveler
