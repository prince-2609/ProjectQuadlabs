...
public class Majestic_multicity extends MajesticMulticity {
	...
	public static void flightMulticity_search(String ddate, String adate, String adate1, String Triptype, String adult,
		...
		QaRobot.ClickOnElement("Majestci_mulpx", "Clicked on Pax");
		...
		// search
		QaRobot.ClickOnElement("Majestic_mulsearch", "Clicked On Search");
