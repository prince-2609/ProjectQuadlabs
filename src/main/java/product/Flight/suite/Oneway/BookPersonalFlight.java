...
public class BookPersonalFlight {
	...
	public static void Sbt_flight_Search(String TestCaseId, String Employee, String TravelerType, String TravelerName,
			...
			String preairline, String nationality, String AirLine, String booknowindex, String adttitle,
			String adultfname, String adultlname, String adultdate, String adultmonth, String adultyear,
			String adultgender, String adultpassprot, String adultnationality, String adultedate, String adultemonth,
			String adulteyear, String adultpassportcomp, String chdtitle, String childfname, String childlname,
			String childdate, String childmonth, String childyear, String childgender, String childpassprot,
			String childnationality, String childedate, String childemonth, String childeyear, String childpassportcomp,
			String inftitle, String infantfname, String infantlname, String infantdate, String infantmonth,
			String infantyear, String infantgender, String infantTravellingWith, String infantpassprot,
			String infantnationality, String infantedate, String infantemonth, String infanteyear,
			String infantpassportcomp, String fop, String receiptno, String card, String cardtype, String cvv,
...
//			QaExtentReport.test.log(Status.INFO, "Result page url is  " + url);
			...
			resultPagePrice = QaBrowser.driver
					.findElement(By.xpath("(//div[@class='fl_price_fmt']/p[2]/span/span[2])[" + booknowindex + "]"))
					.getText();
...
//    			QaExtentReport.test.log(Status.INFO, "Successful Booking " + checkoutpage + "");
				...
				SBTCheckoutPayment.PersonalAdultCheckout(adult, adttitle, adultfname, adultlname, adultdate, adultmonth,
