...
import TestScript.Zamil.ZamilSightseeing;
import utilities.QaLogger;
import utilities.QaRobot;

public class Zamil_Sightseeing extends ZamilSightseeing {

	public static void Sightseen_search(String ccode, String country, String city, String cityname, String pickdate,
			String adult, String child, String nationality, String type, String currency, String Sbooking, String email,
			...
			String adultAddressLine, String adultmeal, String ctitle, String childfname, String childlname,
			String childdate, String childmonth, String childyear, String childnationality,
			String childCountryOfResidence, String childAddressLine, String childmeal, String cardmode, String cardtype,
			String cardno, String cardname, String cardmonth, String cardyear, String cardcvv, String btitle,
			String bfname, String blname, String baddress, String bcity, String bcityauto, String bstate,
			String bzipcode, String bcountry) throws Exception {
		...
		QaRobot.ClickOnElement("zamil_soption", "clicked on more option");
		...
		// search
		QaRobot.ClickOnElement("zamil_ssearch", "Clicked On Serach");
		...
		// "']"));
		// WebElement book = driver.findElement(By.xpath("//a[@id='btnbook" +
		// Sbooking + "']"));
		...
		TransferchildCheckout(ccode, child, ctitle, childfname, childlname, childdate, childmonth, childyear,
				childnationality, childCountryOfResidence, childAddressLine, childmeal);
