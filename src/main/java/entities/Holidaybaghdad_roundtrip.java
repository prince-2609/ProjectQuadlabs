...
import TestScript.Holidaybaghdad.HolidaybaghdadRoundtrip;
import utilities.Logger;
import utilities.QaRobot;

public class Holidaybaghdad_roundtrip extends HolidaybaghdadRoundtrip {
	...
	public static void flight_search(String username, String password, String origin, String forigin,
		...
		QaRobot.ClickOnElement("holiday_roundtrip", "Clicked on RoundTrip");
		...
		// search
		QaRobot.ClickOnElement("holiday_search", "Clicked On Search");
