...
//			QaRobot.selectTextByLocator("//select[@id='grdFlight_ctl02_ddlFlightKey']", TravelPolicyFor);
		} else if (SelectProduct.equalsIgnoreCase("Hotel")) {
//			QaRobot.selectTextByLocator("//select[@id='grdHotel_ctl02_ddlHotelKey']", TravelPolicyFor);
