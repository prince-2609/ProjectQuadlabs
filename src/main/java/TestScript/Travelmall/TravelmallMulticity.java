...
import entities.Travelmall_Fmulticity;
import utilities.QaDataProvider;
import utilities.QaExcelRead;
import utilities.QaRobot;

public class TravelmallMulticity extends Flightcheck {
	...
	public static void flightMultiCitytest(String ccode,String username, String password, String origin, String forigin,
		...
		driver.findElement(By.xpath("//a[@id='tabMultiCity']")).click();
		...
		QaRobot.getWebElement("travelmall_addmulticity").click();
		...
		Travelmall_Fmulticity.flightMulticity_search(ddate, adate, adate1,Triptype, adult, child, infant, fclass, airlines,
