...
public class OneWayDependentFlightBooking extends Flightcheck {
	...
	public Object[][] getexceldata() throws Exception {
		...
		return QaDataProvider.getTestdata("SBT_Flight", "OnewayDependentSheet2");
	}
	...
	public static void Sbt_flight_Search(String TestCaseId, String Employee, String TravelerType, String TravelerName,
			...
			String preairline, String nationality, String Stops, String AirLine, String booknowindex,
			String policyindex, String tripindex, String passportnumber, String fop, String receiptno, String card,
			String cardtype, String cvv, String resultpagestep, String checkoutPageStep, String SeatSelection,
...
//			QaExtentReport.test.log(Status.INFO, "Result page url is  " + url);
			...
			List<WebElement> listOfStop = QaBrowser.driver.findElements(By
					.xpath("//div[@id='FareDetailsController']/div[2]/div/div[1]/div/div[3]/div[4]/div[2]/ul/li/span"));
...
//				QaBrowser.driver.findElement(By.xpath("(//input[contains(@id,'Anchor_')])[" + booknowindex + "]")).click();
				...
				checkoutpage(adult, child, infant, fop, receiptno, card, cardtype, cvv, checkoutPageStep, airReasonCode,
						CreatedBy);
			}
	...
	public static void checkoutpage(String adult, String child, String infant, String fop, String receiptno,
			String card, String cardtype, String cvv, String checkoutPageStep, String airReasonCode, String CreatedBy)
			throws Exception {
