...
public class Flight_Search extends Flight {
	...
	public static void flight_search(String username, String password, String origin, String forigin,
		...
		QaBrowser.driver.findElement(By.xpath("//div[@class='col-md-4 col-xs-4 padd0 flight_tb_li']")).click();
		...
		String searchpage = Logger.takeScreenshot(QaBrowser.driver, "D:\\Screenshot\\SearchPage.png");
		QaExtentReport.test.log(Status.INFO, "Screenshot for Search Page"+searchpage+"");
...
//		QaRobot.explicitwaitinvisible(200, By.xpath("//*[@class='progress-bar progress-bar-striped active']"));
		...
		if (ResultNotFound.isDisplayed()) {
			...
			boolean international = QaBrowser.driver.findElements(By.xpath("//input[starts-with(@id,'Anchor_')]")).size() > 0;

			boolean local = QaBrowser.driver.findElements(By.xpath("//*[@id='btnProcess']")).size() > 0;

			if (international) {

				WebElement international_Flights = QaBrowser.driver.findElement(By.xpath("//input[starts-with(@id,'Anchor_')]"));

				// take screenshot for International result page

				String resultpage = Logger.takeScreenshot(QaBrowser.driver, "D:\\Screenshot\\International Result page.png");
				QaExtentReport.test.log(Status.INFO, "Screenshot for InternationalResultpage"+resultpage+"");
				...
				QaExtentReport.test.log(Status.INFO, "International result fare is " + InternationalFare);
			...
			if (local) {
				...
				WebElement local_flight = QaBrowser.driver.findElement(By.xpath("//*[@id='btnProcess']"));
				...
				QaExtentReport.test.log(Status.INFO,"Domestic result fare is " + Domesticfare[1]);
				...
				String resultpage = Logger.takeScreenshot(QaBrowser.driver, "D:\\Screenshot\\Domestic Result page.png");
				QaExtentReport.test.log(Status.INFO, "Screenshot for DomesticResultpage"+resultpage+"");
...
//			// take screenshot for checkout page
			...
			QaExtentReport.test.log(Status.INFO, "Screenshot for Checkoutpage"+confirmpage+"");

			// If getting change selection then click on send Enquiry

//			WebElement change = QaBrowser.driver.findElement(By.xpath("//a[@id='ctl00_contentMain_expATag']"));
//
