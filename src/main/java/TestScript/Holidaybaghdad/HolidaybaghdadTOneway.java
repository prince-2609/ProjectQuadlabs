...
import entities.Holidaybaghdad_TOneway;
import utilities.QaDataProvider;
import utilities.QaExcelRead;
import utilities.QaRobot;

public class HolidaybaghdadTOneway extends Flightcheck {
	...
	public static void transferOneway(String ccode, String Country, String Pickuptype, String dropofftype,
		...
		test = report.createTest("Holiday baghdad Transfer Oneway");

		QaRobot.ClickOnElement("Transfer", "Clicked on Transfer");

		Holidaybaghdad_TOneway.Transfer_OneWaysearch(ccode,Country, Pickuptype, dropofftype, pickuplocation, pickloctionlist,
