...
import TestScript.Holidaybaghdad.HolidaybaghdadMulticity;
import utilities.Logger;
import utilities.QaRobot;

public class Holidaybaghdad_multicity extends HolidaybaghdadMulticity {
	...
	public static void flightMulticity_search(String ddate, String adate, String adate1, String Triptype, String adult,
		...
		// driver.findElement(By.xpath("//a[@class='datepick-cmd
		// datepick-cmd-next ']")).click();
		...
		// select adult
		driver.findElement(By.xpath("//input[@id='Multicity_Adults']")).clear();
		QaRobot.PassValue("algosaibi_muladult", adult, "Selected Adult");

		// select child
		driver.findElement(By.xpath("//input[@id='Multicity_Child']")).clear();
		QaRobot.PassValue("algosaibi_mulchild", child, "Selected Child");

		// select infant
		driver.findElement(By.xpath("//input[@id='Multicity_Infant']")).clear();
		QaRobot.PassValue("algosaibi_mulinfant", infant, "Selected Infant");
		
		Thread.sleep(200);

		// select class

		QaRobot.selectTextFromDropdown("holiday_mulclass", fclass, "Selected Class");
		...
		// search
		QaRobot.ClickOnElement("holiday_mulsearch", "Clicked On Search");
		...
		if (ResultNotFound.isDisplayed()) {
			...
			try {
				...
				QaRobot.ClickOnElement("holiday_home", "clicked on Home Page");
