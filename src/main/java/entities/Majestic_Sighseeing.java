...
import TestScript.Majestic.MajesticSighseeing;
import TestScript.Sighseeing.Sighseeing;
import utilities.Logger;
import utilities.QaRobot;

public class Majestic_Sighseeing extends MajesticSighseeing {
	...
	public static void Sightseen_search(String ccode,String country, String city, String cityname, String pickdate, String adult,
		...
		QaRobot.selectTextFromDropdown("Majestic_country", country, "Selected Sightseeing Country");

		// Entered City

		TestBase.listofautosuggestion(By.xpath("//div[@id='divHTCity1']/p"), city, cityname,
		...
		QaRobot.ClickOnElement("Majestic_pickupdate", "Clicked on Sightseen Departure");
		...
		// Select Type
		QaRobot.selectTextFromDropdown("S_Type", type, "Selected Nationality");
		
		driver.findElement(By.xpath("(//a[@class='sp_adv_btn'])[7]")).click();
