...
public class BookGuestHotel
{
	...
	public Object[][] getexceldata() throws Exception {
		...
		return QaDataProvider.getTestdata("SBT_Hotel", "GuestSheet1");
	}

	@Test(dataProvider = "getexceldata")
	public static void Sbt_flight_Search(String TestCaseId,String Employee,String TravelArranger,String ccode, String URL,String compcode, String uname, String pwd, String corptraveller,String searchType,
			String origin, String forigin, String chkindate, String chkoutdate, String room,String adult,
			String child, String infant,String ageofchildren,String nationality, String booknowindex,String tripindex,String policyindex,String adttitle, String adultfname, String adultlname,
			String adultdate, String adultmonth, String adultyear, String adultgender,String isd,String phoneNumber,String chdtitle, String childfname, String childlname,
			String childdate, String childmonth, String childyear, String childgender,String LevelApprover,String Level1Approver,String fop, String receiptno, String card, String cardType,
			String cvv, String resultpagestep,String checkoutPageStep, String hotelReasonCode, String hotelRemarks,String CreatedBy) throws Exception {
...
//			// select the checkout date
				...
				QaExtentReport.test.log(Status.INFO,"<b><i>CheckOut date : </i></b>" + chkoutdate);

		//select the room
		QaRobot.selectValueFromDropdown("dep_hotel_traveler", room, "<b><i>Selected the room</i></b>");
...
//				QaRobot.explicitwaitvisible(180, By.xpath("//input[@id='ctl00_contentMain_chkTerms']"));
				...
				SBTCheckoutPayment.GuestHotelAdultCheckout(adult, adttitle, adultfname, adultlname, adultdate, adultmonth, adultyear, adultgender,isd,phoneNumber);
				...
				Thread.sleep(1000);
				TestBase.listofautosuggestion(By.xpath("/html/body/div/form/div[4]/div/div/section/div[1]/div[2]/div[4]/div[2]/div[2]/div[2]/div[3]/div/div/div/div[1]/div[2]/div/div/p"), LevelApprover, Level1Approver,
						By.xpath("//input[@id='ctl00_contentMain_txtApprover1_HTL']"));
				Thread.sleep(2000);
				
//				QaRobot.PassValue("LevelApprover",LevelApprover);
...
//				QaRobot.explicitwaitvisible(300, By.xpath("//div[@class='value_package_details']"));
				...
				QaRobot.ClickOnElement("OKK");
				QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on procced button</i></b>");
				
				WebElement element = QaBrowser.driver.findElement(By.xpath("//select[@id='ctl00_contentMain_ddlCardCC']"));
				Select sel = new Select(element);
				sel.selectByIndex(1);
				Thread.sleep(2000);
...
//					SBTCheckoutPayment.fopCash(fop, receiptno);
				...
				{
					QaRobot.selectTextFromDropdown("ow_selectcard1", card, "<b><i>Selected card: </i></b>" + card);
