...
public class hotelSearchMultiPax extends Flightcheck {
	TestBase t;
	QaExcelRead reader;
	@DataProvider
	public Object[][] getexceldata() throws Exception {

		return QaDataProvider.getTestdata("Hotelsearchmultipax","Sheet1");
	}
	
	@Test(dataProvider = "getexceldata")

	public static void Hotelroom1(String ccode, String username, String password, String city, String Hcity, String sdate, String edate,String Adult,String selectRommIndex, String title, String firstname,
			String lastname, String phone,String Stitle, String Sfirstname, String Slastname, String Ctype, String Ccnumber, String Chname, String mm, String yyyy,String Securitycode,  String Btitle, String Bfirstname, String Blastname, String Baddress, String Bcity,String Btcity, String emailid) throws Exception {
		...
		QaRobot.ClickOnElement("Hotel_depart_date","Clicked on Hotel Departure"); // calendar
		
		QaBrowser.driver.findElement(By.xpath("//a[@id='id"+sdate+"']")).click(); //sdate
		
		Thread.sleep(100);
		
		QaRobot.ClickOnElement("Hotel_end_date","Clicked on end date"); // calendar
        ...
        QaRobot.selectValueFromDropdown("Adultsecond",Stitle,"click on title"); 
		
		Thread.sleep(100);
		
        QaRobot.PassValue("S_fist_name",Sfirstname,"Write firstname");
		
	    Thread.sleep(100);
	     
	    QaRobot.PassValue("S_Last_name",Slastname,"Write lasttname");
