...
public class ExpenseManagementReport 
{
	...
	{
		return QaDataProvider.getTestdata("ExpenseManagement", "ExpenseManagementReport");
	}
	
	@Test(dataProvider = "getexceldata")
	public static void Profiling1(String Source,String URL, String Comapnycode,String Username,String Password,String SelectReport,String ApplyFilter,
			String ReportType,String Branch,String CostCenter,String Department,String Designation,String Grade,String Project,String ProductName,
			String BranchNumber,String BranchName,String LSRReportType,String LSRDivision,String LSRDepartment,String LSRCostCenter,String LSRProductType) throws Exception 
	{
		TestBase.Companycode(Source,URL); 
		QaRobot.impliwait(30);
		
		QaExtentReport.test = QaExtentReport.report.createTest("Test on CAM Reports");
...
//		QaBrowser.driver.close();
	...
	public static void expenseReport(String ReportType,String Branch,String CostCenter,String Department,String Designation,
			String Grade,String Project) throws Exception 
	{
	...
	public static void DailySalesReports(String BranchNumber,String BranchName) throws Exception
	{
		...
		for (int i = 1; i <= bN; i++) 
		{
			...
			TestBase.listofautosuggestion3(By.xpath("//select[@id='frmbranch']/option"),a,By.xpath("//input[@id='branch_insert']"));
		}
	}
	...
	public static void Reports(String ReportType,String Branch,String CostCenter,String Department,String Designation,
			String Grade,String Project) throws Exception 
	{
