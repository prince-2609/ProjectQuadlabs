...
public class GobdgoOneway extends Flightcheck {
	...
	public static void flightOneway(String ccode,String username, String password, String origin, String forigin, String destination,
		...
		//ClickOnElement("gobdgo_oneway", "Clicked on Oneway");
		driver.findElement(By.xpath("//a[@id='tabOneWay']")).click();
		...
		test = report.createTest("Gobdgo Flight Oneway");
