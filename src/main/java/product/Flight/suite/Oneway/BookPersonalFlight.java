...
public class BookPersonalFlight
{
	...
	public static void Sbt_flight_Search(String ccode, String URL, String compCode, String uname, String pwd,
			...
			String preairline, String nationality, String booknowindex, String adttitle, String adultfname,
			...
			String receiptno, String card, String cardtype, String cvv) throws Exception {

		QaExtentReport.test = QaExtentReport.report.createTest("Test On Create Personal booking");
