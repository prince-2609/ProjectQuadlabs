...
public class TestOn_AssignTravelArranger_To_BookingFlow {

	@DataProvider
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("TestOn_AssignTravelArranger_To_BookingFlow", "Sheet9");
	}
	...
	public static void flightBooking(String TestCaseId, String TestScenario, String Source, String MoURL,
			...
			String TotalTraveller, String TravellerNames, String SearchRuleStatus, String RSqty,
...
//		Thread.sleep(3000);
		...
		for (int a = 1; a <= pAS; a++) {
			...
			if (LoginType.equalsIgnoreCase("Normal")) {
				...
				String[] tN = Emailid.split(",");
				String Emailid1 = tN[a - 1];
				QaRobot.PassValue("EmailId", Emailid1);
...
//			Thread.sleep(2000);
				if (TravelerType.equalsIgnoreCase("Administrator")
						|| TravelerType.equalsIgnoreCase("Travel Arranger")) {
...
//		QaRobot.selectTextFromDropdown("APolicy", Policy);
					...
					QaBrowser.driver
							.findElement(By
									.xpath("//div[@id='flight_way1']/div[2]/div[1]/div/div/label/span[2]/span[1]/img"))
							.click();
...
//			Thread.sleep(2000);
				...
				String[] tN = DepartureDate.split(",");
				String DepartureDate1 = tN[a - 1];
				String DateSelection[] = DepartureDate1.split("-");
				String year = DateSelection[2];
				String month = DateSelection[1];
				String expDate = DateSelection[0];
				String DateSelection1[] = ReturnDate.split("-");
...
//		QaRobot.selectTextFromDropdown("APolicy", Policy);
					Thread.sleep(2000);
					QaBrowser.driver.findElement(By.xpath("//div[@id='tab1']/div[2]/div[4]/div[1]/span[2]/img"))
							.click();
...
//				QaExtentReport.test.log(Status.INFO, "<b><i>Result page price is </i></b>" + resultPagePrice);
						...
						if (Resultpagestep.equalsIgnoreCase("Trip Request")) {
							...
							checkoutpage(ccode, FareBranding, searchType, Trip, adult, child, infant, Stops,
									OneWayAirLine, RoundTripAirLine,
