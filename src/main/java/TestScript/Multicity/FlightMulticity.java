...
import entities.FlightMulticity_search;
import utilities.QaDataProvider;
import utilities.QaExcelRead;
import utilities.QaRobot;

public class FlightMulticity extends Flightcheck {
	...
	public Object[][] getexceldata() throws Exception {
		...
		return QaDataProvider.getExceldata("MultiCity1","Sheet1");
	}
	...
	public static void flightMultiCitytest(String ccode,String username, String password, String origin, String forigin,
		...
		driver.findElement(By.xpath("//a[contains(text(),'Multi City')]")).click();
		...
		QaRobot.getWebElement("thirdcity").click();
		...
		test = report.createTest("flightMultiCity");

		FlightMulticity_search.flightMulticity_search(ddate, adate, adate1,Triptype, adult, child, infant, fclass, airlines,
