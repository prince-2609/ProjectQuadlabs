...
public class Arivo_Oneway extends ArivoOneway {
	...
	public static void flightoneway(String ddate, String Triptype, String adult, String child, String infant,
		...
		QaRobot.selectTextFromDropdown("Arivo_class", fclass, "Selected Class");
		...
		// search
		QaRobot.ClickOnElement("Arivo_search", "Clicked On Serach");
