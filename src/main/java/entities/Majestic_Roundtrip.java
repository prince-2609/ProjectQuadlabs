...
public class Majestic_Roundtrip extends MajesticRoundtrip {
	...
	public static void flight_search(String username, String password, String origin, String forigin,
		...
		QaRobot.ClickOnElement("Majestic_roundtrip", "Clicked on RoundTrip");
		...
		// ClickOnElement("Majestic_moreoption", "Clicked on more option");
		//
		// //select currency
		//
		// selectTextFromDropdown("Majestic_currency", "fcurrency", "Selected
		// Currency");
		//
		// // select class
		//
		// selectTextFromDropdown("Majestic_class", fclass, "Selected Class");
		...
		// search
		QaRobot.ClickOnElement("Majestic_search", "Clicked On Search");
		...
		if (ResultNotFound.isDisplayed()) {
			...
			// else {
			//
			// CompareFareValue(Domesticstr, checkout, " checkout page " +
			// checkout);
			//
			// }
