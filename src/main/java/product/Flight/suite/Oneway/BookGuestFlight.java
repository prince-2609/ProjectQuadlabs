...
public class BookGuestFlight
{
	...
	public static void Sbt_flight_Search(String TestCaseId,String Employee,String TravelerType,String TravelerName,String ccode, String URL,String compCode,String uname, String pwd, String corptraveller,String searchType, String origin,
			...
			String cvv, String resultpagestep, String checkoutPageStep, String airReasonCode,String AirTextTrvlr,String CreatedBy) throws Exception {
...
//			QaExtentReport.test.log(Status.INFO, "Result page url is  " + url);
			...
			resultPagePrice = QaBrowser.driver.findElement(By.xpath("(//div[@class='fl_price_fmt']/p[2]/span/span[2])[" + tripindex + "]")).getText();
			...
			else if (resultpagestep.equalsIgnoreCase("Flight Book")) 
			{
				...
				checkoutpage(checkoutPageStep,adult,adttitle,adultfname,adultlname,adultdate,adultmonth,adultyear,adultgender,
						...
						infanteyear,infantpassportcomp,airReasonCode,AirTextTrvlr,fop,receiptno,card,cardtype,cvv,CreatedBy);
			}
		}
	}
	...
	public static void checkoutpage(String checkoutPageStep,String adult,String adttitle,String adultfname,String adultlname,String adultdate,String adultmonth,
			...
			String infantedate,String infantemonth,String infanteyear,String infantpassportcomp,String airReasonCode,String AirTextTrvlr,String fop,String receiptno,String card,String cardtype,String cvv,String CreatedBy) throws Exception 
	{
