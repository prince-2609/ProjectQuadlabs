...
public class EnableAndDisableInstantForHotel {
	@DataProvider
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("InstantAndDisableforHotel", "Non branding");
	}

	@Test(dataProvider = "getexceldata")

	public static void InstantBookingAndDisableApprovalForHotel(String TestCaseId, String TestScenario, String Source,
			String MoURL, String CompanyCode, String UserName, String Password, String CorporateName,
			String EnableInstantbooking, String EnableInstantQty, String InstantAppliedOn,
			String DisableApprovalWorkflow, String DisableApprovalQty, String DisableApprovalAppliedOn, String ccode,
			String URL, String LoginType, String Emailid, String SDN, String EmployeName, String TravelerType,
			String loginname, String Loginpassword, String CoporateName, String FareBranding, String DashboardType,
			String CorporateTraveller, String SearchType, String Trip, String CityCode, String CityTitle,
			String ChooseRadius, String CheckInDate, String CheckOutDate, String Rooms, String Adult, String Child,
			String ChildAge, String SearchRuleStatus, String BookNowIndex, String PolicyIndex, String TripRequestIndex,
			String ModifySearch, String TravellerTypeM, String ChangeTripLocation, String CityCodeM, String CityTitleM,
			String ChangeRadius, String ChooseRadiusM, String ChangeTripDate, String CheckInDateM, String CheckOutDateM,
			String ChangeRooms, String RoomsM, String AdultM, String ChildM, String ChildAgeM, String Applyfilter,
			String ChangeStarRating, String StarRatingM, String ChangePropertyType, String SelectProperty,
		...
		QaRobot.switchframe("//frame[@id='frm2']");
		Thread.sleep(3000);
		QaRobot.ClickOnElement("ManagecorporateSetting");
		Thread.sleep(5000);
		if (EnableInstantbooking.equalsIgnoreCase("Yes")) {
			Thread.sleep(2000);
			QaRobot.scrollPage(1000);
			Thread.sleep(2000);
			QaRobot.ClickOnElement("CheckEnableInstant");
			int pA2 = Integer.parseInt(EnableInstantQty);
			for (int k = 1; k <= pA2; k++) {
				int count = 0;
				String[] tN1 = InstantAppliedOn.split(",");
				String b1 = tN1[k - 1];
				List<WebElement> listOfRights1 = QaBrowser.driver.findElements(By.xpath(
						"/html/body/form/div[3]/div/div/div[2]/div/div[4]/div/div[1]/div/div/div/div[40]/div/div/div//span"));
				for (WebElement autoRights1 : listOfRights1) {
					count++;
					System.out.println(count);
					if (autoRights1.getText().equalsIgnoreCase(b1)) {
						WebElement clickenableinstant = QaBrowser.driver.findElement(By.xpath(
								"(/html/body/form/div[3]/div/div/div[2]/div/div[4]/div/div[1]/div/div/div/div[40]/div/div/div/input)["
										+ count + "]"));
						clickenableinstant.click();
						Thread.sleep(2000);
						QaExtentReport.extentScreenshot("Enable Instant Booking");
						Thread.sleep(2000);
					}
				}
			}
		}
		if (DisableApprovalWorkflow.equalsIgnoreCase("Yes")) {
			Thread.sleep(3000);
			QaRobot.scrollPage(1000);
			Thread.sleep(2000);
			QaRobot.ClickOnElement("Checkdisableapproval");
			QaRobot.scrollPage(800);
			int pA2 = Integer.parseInt(DisableApprovalQty);
			for (int k = 1; k <= pA2; k++) {
				int count = 0;
				String[] tN1 = DisableApprovalAppliedOn.split(",");
				String b1 = tN1[k - 1];
				List<WebElement> listOfRights1 = QaBrowser.driver.findElements(By.xpath(
						"/html/body/form/div[3]/div/div/div[2]/div/div[4]/div/div[1]/div/div/div/div[44]/div/div/div//span"));
				for (WebElement autoRights1 : listOfRights1) {
					count++;
					System.out.println(count);
					if (autoRights1.getText().equalsIgnoreCase(b1)) {
						WebElement ClickonDisableApproval = QaBrowser.driver.findElement(By.xpath(
								"(/html/body/form/div[3]/div/div/div[2]/div/div[4]/div/div[1]/div/div/div/div[44]/div/div/div/input)["
										+ count + "]"));
						ClickonDisableApproval.click();
						Thread.sleep(2000);
						QaExtentReport.extentScreenshot("Disable Approval Workflow");
						Thread.sleep(2000);
					}
				}
			}
		...
		QaRobot.ClickOnElement("Savecorporatesettings");
		Thread.sleep(4000);
...
//								throw new B2cExceptionClass("Invalid Child Age Selection" + " : " + ac1);
		...
		QaRobot.DoubleClickOnElement("OldHotelSelect");
//		QaExtentReport.extentScreenshot("Result Page");
		Thread.sleep(3000);
...
//				QaRobot.switchToWindow();
				...
				if (ccode.equalsIgnoreCase("Live")) {
					...
					String getT = QaBrowser.driver.findElement(By.xpath("(//span[contains(@id,'Policy1')])[3]"))
							.getText();
					QaExtentReport.extentScreenshot("Hotel Results");
					QaRobot.ClickOnElement("AddToCartHotelCX");
					if (getT.equalsIgnoreCase("Out Of Policy")) {
...
//		QaExtentReport.extentScreenshot("Sigh In Page");
		...
		QaRobot.ClickOnElement("SearchCompanyName");
//		QaExtentReport.test.log(Status.INFO, "<b><i>Corporate Name</i></b>" + " - " + CorporateName);
//		String AccountId1 = QaBrowser.driver.findElement(By.xpath("//span[@id='GridView1_ctl02_Label2']")).getText();
//		QaExtentReport.test.log(Status.INFO, "<b><i>Account Id</i></b>" + " - " + AccountId1);
		QaRobot.ClickOnElement("ClickOnSearchCompanyName");
		QaBrowser.driver.switchTo().parentFrame();
		QaRobot.switchframe("//frame[@id='toolHeader']");
		QaRobot.ClickOnElement("CPCorporateManagement");
...
//		System.out.println(date3);
		...
		Thread.sleep(2000);
		String monthYear1 = QaBrowser.driver.findElement(By.xpath("/html/body/div[6]/div/div[2]/div[1]/div")).getText();
		Thread.sleep(2000);
		...
		while (!(month1.equals(Month1) && year1.equals(Year1))) {
			QaBrowser.driver.findElement(By.xpath("/html/body/div[6]/div/div[1]/a[3]")).click();
			monthYear1 = QaBrowser.driver.findElement(By.xpath("/html/body/div[6]/div/div[2]/div[1]/div")).getText();
