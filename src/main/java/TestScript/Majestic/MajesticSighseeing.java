...
import entities.Majestic_Sighseeing;
import utilities.QaDataProvider;
import utilities.QaExcelRead;
import utilities.QaRobot;

public class MajesticSighseeing extends Flightcheck {
			...
			String bcountry) throws Exception
	{
		...
		Companycode(ccode);
		test = report.createTest("Majestic sightseeing");
		
		QaRobot.ClickOnElement("sightseen", "Clicked on sightseeing");
		
		Majestic_Sighseeing.Sightseen_search(ccode,country, city, cityname, pickdate, adult, child, nationality, type, currency,Sbooking,email, title, adultfname, adultlname,
