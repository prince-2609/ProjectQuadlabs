...
public class Algosaibi_multicity extends AlgosaibiMulticity
{
	...
	public static void flightMulticity_search(String ddate, String adate, String adate1, String Triptype, String adult,
		...
		//explicitwaitinvisible(30, By.xpath("//DIV[@id='dynamultiarr3']/P"));
...
//		// departure date3
//        Thread.sleep(500);
//		ClickOnElement("dep_date3", "Clicked on Flight return date Button");
//		Thread.sleep(500);
...
//        tripDays2.executeScript("arguments[0].click();", departdate2);
		...
		// Pax
        Thread.sleep(500);
		QaRobot.ClickOnElement("algosaibi_multipax", "clicked on select PAX");
...
//		getLocator(Fclass).click();
		...
		// search
		QaRobot.ClickOnElement("algosaibi_mulsearch", "Clicked On Search");
