...
import entities.Zamil_Roundtrip;
import utilities.QaDataProvider;
import utilities.QaExcelRead;

public class ZamilRoundtrip extends Flightcheck {
...
//		}
		...
		test = report.createTest("Zamil FlightRoundTrip");
		
		Zamil_Roundtrip.flight_search(language,username, password, origin, forigin, destination, fdestination, ddate, adate,
