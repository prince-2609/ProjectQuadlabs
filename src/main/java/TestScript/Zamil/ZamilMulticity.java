...
import entities.Zamil_multicity;
import utilities.QaDataProvider;
import utilities.QaExcelRead;
import utilities.QaRobot;

public class ZamilMulticity extends Flightcheck {
...
//		}
		...
		driver.findElement(By.xpath("//button[@id='Addmulti']")).click();
		...
		test = report.createTest("Zamil flight MultiCity");

		Zamil_multicity.flightMulticity_search(language,ddate, adate, adate1, Triptype, adult, child, infant, fclass, airlines,
