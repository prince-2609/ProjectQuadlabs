...
public class TestOnHotel_FFno_HotelMembershipNo_To_BookingFlow {
	...
	public static void Sbt_Hotel_Search(String TestCaseId, String TestScenario, String Source, String MoURL,
			String CompanyCode, String UserName1, String Password1, String CorporateName, String TravellerName,
			String HMNHotelName, String HMNumber, String FFAirline, String FFExpiryDate, String FFLoyaltyNumber,
			String ccode, String URL, String LoginType, String Emailid, String SDN, String EmployeName,
			String TravelerType, String UserName, String Password, String CoporateName, String FareBranding,
			String DashboardType, String CorporateTraveller, String SearchType, String Trip, String CityCode,
			String CityTitle, String ChooseRadius, String CheckInDate, String CheckOutDate, String Rooms, String Adult,
			String Child, String ChildAge, String SearchRuleStatus, String BookNowIndex, String PolicyIndex,
			String TripRequestIndex, String ModifySearch, String TravellerTypeM, String ChangeTripLocation,
			String CityCodeM, String CityTitleM, String ChangeRadius, String ChooseRadiusM, String ChangeTripDate,
			String CheckInDateM, String CheckOutDateM, String ChangeRooms, String RoomsM, String AdultM, String ChildM,
			String ChildAgeM, String Applyfilter, String ChangeStarRating, String StarRatingM,
			String ChangePropertyType, String SelectProperty, String HotelName, String Resultpagestep,
...
//					}
				...
				if (ccode.equalsIgnoreCase("Live")) {
					String getT = QaBrowser.driver.findElement(By.xpath("(//span[contains(@id,'Policy3')])[1]"))
							.getText();
					...
					String getT = QaBrowser.driver.findElement(By.xpath("(//span[contains(@id,'Policy1')])[1]"))
							.getText();
					QaExtentReport.extentScreenshot("Hotel Results");

					List<WebElement> corpUsers = QaBrowser.driver
							.findElements(By.xpath("//div[@id='nrm_box_1']/div[2]/label/div[2]/h4"));
					int index = 0;
					for (WebElement cropUser : corpUsers) {
						String TextofCropUser = cropUser.getText();
						String HotelRoom[] = TextofCropUser.split(" ");
						String RoomType = HotelRoom[0] + HotelRoom[1] + HotelRoom[2] + HotelRoom[3];
						System.out.println(RoomType);
						index = index + 1;
						Thread.sleep(3000);
						if (RoomType.equalsIgnoreCase("LOYALTYPROGRAMMEMBERSHIPREQUIRED")) {
							QaBrowser.driver.findElement(By.xpath(
									"/html/body/div[1]/div[2]/div/div[2]/section[1]/div[2]/div[3]/div[2]/div[1]/div/div[2]/div[2]/div[3]/div/div/div/div/div[2]/label["
											+ index + "]/div[5]/p[3]/span"))
									.click();
							if (getT.equalsIgnoreCase("Out Of Policy")) {
								QaRobot.alertAccept();
							}
