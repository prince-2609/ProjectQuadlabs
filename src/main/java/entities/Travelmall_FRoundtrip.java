...
import TestScript.Travelmall.TravelmallRoundtrip;
import utilities.Logger;
import utilities.QaRobot;

public class Travelmall_FRoundtrip extends TravelmallRoundtrip {
	...
	public static void flight_search(String username, String password, String origin, String forigin,
		...
		QaRobot.ClickOnElement("travelmall_roundtrip", "Clicked on RoundTrip");
...
//		getLocator(Fclass).click();
		...
		// search
		QaRobot.ClickOnElement("travelmall_flight_search", "Clicked On Search");
