...
import entities.Zamil_Oneway;
import utilities.QaDataProvider;
import utilities.QaExcelRead;

public class ZamilOneway extends Flightcheck {
	...
	public static void flightOneway(String ccode,String language,String username, String password, String origin, String forigin, String destination,
		...
		driver.findElement(By.xpath("//a[text()='One Way ']")).click();
