...
//					if (Server.equalsIgnoreCase("Staging") || Server.equalsIgnoreCase("Xchange")) {
				String getT = QaBrowser.driver.findElement(By.xpath("(//span[contains(@id,'Policy127301')])[1]"))
						.getText();
...
//					}
				...
				if (ccode.equalsIgnoreCase("Live")) {
					String getT = QaBrowser.driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div[2]/section[1]/div[2]/div[3]/div[2]/div[1]/div/div/div[2]/div[2]/div[2]/div[1]/div/span"))
							.getText();
			...
			if (ProductType.equalsIgnoreCase("Hotel")) {
				if (ccode.equalsIgnoreCase("Live")) {
					...
					QaRobot.ClickOnElement("ProceedNonbrandingATC");
				}
...
//				WebElement element = QaBrowser.driver
//						.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture169074']"));
//				Select sel = new Select(element);
//				sel.selectByIndex(1);
//				Thread.sleep(2000);
...
//						.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture169080']"));
