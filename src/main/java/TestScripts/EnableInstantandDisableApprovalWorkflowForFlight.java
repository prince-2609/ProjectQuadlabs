...
public class EnableInstantandDisableApprovalWorkflowForFlight {

	@DataProvider
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("EnableInstantandDisableApprovalWorkflow", "Sheet4");
	}

	@Test(dataProvider = "getexceldata")

	public static void EnableInstantDisableApproval(String TestCaseId, String TestScenario, String Source, String MoURL,
			String CompanyCode, String UserName, String Password, String CorporateName, String EnableInstantbooking,
			String EnableInstantQty, String InstantAppliedOn, String DisableApprovalWorkflow, String DisableApprovalQty,
			String DisableApprovalAppliedOn, String SearchRuleStatus, String RSqty, String RulesAppliedOnSearchPage,
			String ccode, String LoginType, String URL, String Emailid, String SDN, String EmployeName,
...
//							Thread.sleep(5000);
					...
					if (OneWayAirLine.equalsIgnoreCase("Air India")) {
						if (OneWayFareType.equalsIgnoreCase("ECO COMFORT")) {
...
//					QaExtentReport.extentScreenshot("Flight Itinerary");
					Thread.sleep(3000);
					QaRobot.DoubleClickOnElement("AMoreDetails");
//					QaRobot.ClickOnElement("AMoreDetails1");
					Thread.sleep(7000);
					QaRobot.scrollPage(300);
					Thread.sleep(3000);
					QaExtentReport.extentScreenshot("Result Page");
...
//							Thread.sleep(5000);
					...
					if (RoundTripAirLine.equalsIgnoreCase("Air India")) {
						if (RoundTripFareType.equalsIgnoreCase("ECO COMFORT")) {
							QaRobot.ClickOnElement("AddToCartJ1");
							if (getT1.equalsIgnoreCase("Out of policy")) {
								QaRobot.alertAccept();
							}
...
//		QaExtentReport.extentScreenshot("Sigh In Page");
		...
		QaRobot.ClickOnElement("SearchCompanyName");
//		QaExtentReport.test.log(Status.INFO, "<b><i>Corporate Name</i></b>" + " - " + CorporateName);
//		String AccountId1 = QaBrowser.driver.findElement(By.xpath("//span[@id='GridView1_ctl02_Label2']"))
//				.getText();
