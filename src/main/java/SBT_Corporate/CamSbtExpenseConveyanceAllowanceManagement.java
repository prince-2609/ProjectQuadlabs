...
public class CamSbtExpenseConveyanceAllowanceManagement 
{
	...
	public static void Profiling1(String Source,String URL, String Comapnycode,String Username,String Password,String ConveyanceAllowanceName,
			String RatePer,String RateAmount,String ConApplicableOn,String ConApplicableSearchType,String ConTypeSelect,String ConTypeName) throws Exception 
	{
		TestBase.Companycode(Source,URL); 
		QaRobot.impliwait(30);
		
		QaExtentReport.test = QaExtentReport.report.createTest("Test on CAM SBT Expense Conveyance Allowance Management Listener");
...
//		QaBrowser.driver.close();
	...
	public static void conApplicableSearchType(String ConApplicableSearchType,String ConTypeSelect, String ConTypeName) throws Exception
	{
