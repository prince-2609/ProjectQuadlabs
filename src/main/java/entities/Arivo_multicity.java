...
public class Arivo_multicity extends ArivoMulticity {
	...
	public static void flightMulticity_search(String ddate, String adate, String adate1, String Triptype, String adult,
		...
		QaRobot.selectTextFromDropdown("arivo_muladult", adult, "Selected Adult");
		
		// select child

		QaRobot.selectTextFromDropdown("arivo_mulchild", child, "Selected Child");

		// select infant

		QaRobot.selectTextFromDropdown("arivo_mulinfant", infant, "Selected Infant");

		Thread.sleep(500);

		// select class
		
		QaRobot.selectTextFromDropdown("arivo_mulclass", fclass, "Selected Class");
		...
		// search
		QaRobot.ClickOnElement("arivo_multisearch", "Clicked On Search");
