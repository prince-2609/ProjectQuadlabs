...
public class hotelBusinessTrip
{
	...
	public Object[][] getexceldata() throws Exception {
		...
		return QaDataProvider.getTestdata("SBT_Hotel", "Sheet4");
	}
	
	@Test(dataProvider = "getexceldata")
	public static void Sbt_flight_Search(String TestCaseId,String Employee,String TravelerType,String TravelerName,String ccode, String URL,String compcode, String uname, String pwd, String corptraveller,String searchType,
