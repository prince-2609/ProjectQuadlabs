...
import TestScript.Zamil.ZamilOneway;
import utilities.Logger;
import utilities.QaRobot;

public class Zamil_Oneway extends ZamilOneway {

	@SuppressWarnings("deprecation")
	public static void flightoneway(String language, String ddate, String Triptype, String adult, String child,
			String infant, String fcurrency, String fclass, String airlines, String fbooking, String emailid,
		...
		QaRobot.ClickOnElement("zamil_option", "clicked on more option");
		...
		List<WebElement> ResultNotFound = driver.findElements(By.xpath(
				"//*[text()='Oops! Seems like no flight journeys are available for the selected search criteria.']"));
		...
		if (ResultNotFound.size() > 0) {
			...
			System.out.println("checout fare before fee is " + checkout);
