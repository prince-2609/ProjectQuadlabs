...
public class OnewayBussinessFlightTrip 
{
	...
	public Object[][] getexceldata() throws Exception {
		...
		return QaDataProvider.getTestdata("SBT_Flight", "OneWaySheet1");
	}
	...
	public static void Sbt_flight_Search(String TestCaseId,String Employee,String TravelerType,String TravelerName,String ccode, String URL,String compCode,String uname, String pwd, String corptraveller,String searchType, String origin,
		...
		QaExtentReport.test.log(Status.INFO, TravelerType+"<b><i> Name is  </i></b>"+TravelerName);
		// select the traveler
...
//			QaExtentReport.test.log(Status.INFO, "Result page url is  " + url);
			...
			else if (resultpagestep.equalsIgnoreCase("Flight Book")) 
			{
				...
				checkoutpage(fop,receiptno,card,cardtype,cvv,checkoutPageStep,airReasonCode,CreatedBy);
			}
...
//close international 
	...
	public static void checkoutpage(String fop,String receiptno,String card,String cardtype,String cvv,String checkoutPageStep,String airReasonCode,String CreatedBy) throws Exception 
	{
