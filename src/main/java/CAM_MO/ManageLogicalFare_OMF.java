...
public class ManageLogicalFare_OMF {
	...
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("ManageLogicalFare_OMF", "nological");
	}

	@Test(dataProvider = "getexceldata")
	public static void OBTFulfillment(String TestCaseId, String TestCaseType, String TestScenario, String Source,
			String URL, String CompanyCode, String UserName, String Password, String CorporateName, String SLogicalFare,
			String AppliedFareOn, String Alreadyclicked, String HHFD, String MMFD, String HHFBD, String HHRD,
			String MMRD, String HHRBD, String HHFI, String MMFI, String HHFBI, String HHRI, String MMRI, String HHRBI)
			throws Exception {
...
//			String Status1 = QaBrowser.driver.findElement(By.xpath("//span[@id='GridView1_ctl02_Label2']")).getText();
