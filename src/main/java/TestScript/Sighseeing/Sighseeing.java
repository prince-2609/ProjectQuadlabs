...
import entities.Sighseeing_Search;
import utilities.QaDataProvider;
import utilities.QaExcelRead;
import utilities.QaRobot;

public class Sighseeing extends Flightcheck {
			...
			String bcountry) throws Exception
	{
		...
		Companycode(ccode);
		test = report.createTest("Sightseeing");
		
		QaRobot.ClickOnElement("sightseen", "Clicked on sightseeing");
		
		Sighseeing_Search.Sightseen_search(ccode,country, city, cityname, pickdate, adult, child, nationality, type, currency,Sbooking,email, title, adultfname, adultlname,
