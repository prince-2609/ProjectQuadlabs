...
import entities.Arivo_multicity;
import utilities.QaDataProvider;
import utilities.QaExcelRead;
import utilities.QaRobot;

public class ArivoMulticity extends Flightcheck {
	...
	public static void flightMultiCitytest(String ccode,String username, String password, String origin, String forigin,
		...
		driver.findElement(By.xpath("//a[text()='Multicity']")).click();
		...
		test = report.createTest("Arivo flight MultiCity");

		Arivo_multicity.flightMulticity_search(ddate, adate, adate1,Triptype, adult, child, infant, fclass, airlines,
